...
<body>
	<table border="1">
		...
		<tr>
			<td>
				<button onclick="location.href='ProfileC'">프로필 사진변경</button>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td>체크포인트</td>
			<td>${sessionScope.accountInfo.checkPoint}</td>
		</tr>
		<tr>
			<td>등급</td>
			<td>${sessionScope.accountInfo.typeOfManger}</td>
			<td><button onclick="location.href='LevelUp?typeOfManger=${sessionScope.accountInfo.typeOfManger}&checkPoint=${sessionScope.accountInfo.checkPoint}&id=${sessionScope.accountInfo.id}'">등급업</button></td>
		</tr>
	</table>
